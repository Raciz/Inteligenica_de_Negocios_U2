...
#Codigo para realizar la grafica de barras
ayos = ["2011","2012","2013","2014","2015","2016","2017"] #etiquetas

fig = plt.figure('Crímenes por año')
ax = fig.add_subplot(111)
xx = range(1, len(years)+1)

ax.bar(xx, years, width=0.8,  color=['blue','red','green','orange','brown','purple','pink'], align="center") #barras
ax.set_xticks(xx) #numero de barras
ax.set_xticklabels(ayos) #se agregan las etiquetas
